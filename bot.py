linkPechincha = "https://a.aliexpress.com/_mqIbyVn"
...
while True:
    try:
        ...
        if useProxy:
            ...
            chrome_options.add_argument("--proxy-server=https://%s" % selectedProxy)
        ...
        Emails = open('User.txt', 'a', encoding="utf8")
        Emails.write(randemail + '\n')
        Emails.close()
        print(
            str(hr.tm_hour)
            + ":"
